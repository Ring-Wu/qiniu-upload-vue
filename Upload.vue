...
<div id="video_container">
    <div>
        ...
        <!-- <button @click='pauseUpload' v-if="showpause">暂停上传</button>
        <button @click='continueUpload' v-if="showcontinue">继续上传</button>  -->
    </div>
</div>
</template>
      ...
      _this.uploader = Qiniu.uploader({
        ...
        init: {
          ...
          UploadProgress: function(up, file) {
            ...
            _this.$emit("on-percente", _this.filePercent);
          ...
          FileUploaded: function(up, file, info) {
            ...
            _this.$emit("on-change", sourceLink);
          },
          ...
          var key = _this.filename+file.name;
